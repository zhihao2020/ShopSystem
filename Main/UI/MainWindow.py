...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.thing_name.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(12)
        self.thing_name.setFont(font)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.menu_6.setTitle(_translate("mainWindow", "处理"))
        ...
        self.action_9.setText(_translate("mainWindow", "检查更新"))
        self.action_10.setText(_translate("mainWindow", "备份"))
        self.action_11.setText(_translate("mainWindow", "打印上次小票"))
        self.action_12.setText(_translate("mainWindow", "用户消费金额"))
